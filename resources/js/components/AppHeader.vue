...
import { CarFront, LayoutGrid, Menu, Settings, UserCog } from 'lucide-vue-next';
            ...
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <div class="ml-auto flex items-center space-x-2">
                    <div class="hidden items-center space-x-2 lg:flex">
                        <template v-for="item in mainNavItems" :key="`quick-${item.title}`">
                            <Link
                                :href="item.href"
                                class="rounded-lg px-3 py-1.5 text-sm text-muted-foreground transition hover:text-foreground"
