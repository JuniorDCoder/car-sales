...
class SiteSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'site_logo_url', 'value' => '/images/autonest-logo.svg', 'type' => 'url', 'label' => 'Site Logo URL', 'group' => 'branding'],
            ['key' => 'address', 'value' => '123 Motor Mile Drive, Los Angeles, CA 90001', 'type' => 'textarea', 'label' => 'Physical Address', 'group' => 'contact'],
            ['key' => 'facebook_url', 'value' => 'https://facebook.com/autonest', 'type' => 'url', 'label' => 'Facebook Page URL', 'group' => 'social'],
            ['key' => 'instagram_url', 'value' => 'https://instagram.com/autonest', 'type' => 'url', 'label' => 'Instagram Profile URL', 'group' => 'social'],
